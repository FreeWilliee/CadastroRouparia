    ...
    begin
      MessageDlg('Preencha os campos com *', mtInformation, [mbOK], 0);
          ...
          begin
            ...
            //d_mod_dad.seg.Parameters[3].Value := 'SOLICITAÇÃO ROUPARIA';
...
//Muda a cor do campo conforme é atualizado os seus níveis de liberação
...
begin
  ...
  begin
    begin
     if messagedlg('Deseja autorizar a liberação deste Uniforme?', mtconfirmation, [mbyes, mbno],0)=mryes then
        begin
...
//Indica que o material está em falta
...
//Material não está mais em falta e é atualizado para aguardar aprovação
